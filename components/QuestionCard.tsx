...
const QuestionCard: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl p-6 md:p-8 bg-white/60 dark:bg-black/20 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200/50 dark:border-neutral-800/50 animate-fade-in">
